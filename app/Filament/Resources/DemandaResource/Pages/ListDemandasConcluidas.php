...
class ListDemandasConcluidas extends ListRecords
{
    protected static string $resource = DemandaResource::class;

    protected static ?string $navigationLabel = 'Concluídas';
    ...
    protected static ?string $title = 'Demandas Concluídas';
    ...
    protected function getTableQuery(): Builder
    {
        ...
        // Filtrar apenas status "Concluídas" (Cancelada, Concluído, Homologada)
        $statusConcluidas = Status::whereIn('nome', ['Cancelada', 'Concluído', 'Homologada'])->pluck('id');
        $query->whereIn('status_id', $statusConcluidas);
